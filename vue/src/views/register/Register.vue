<template>
  ...
  <div class="mt-10 sm:mx-auto sm:w-full sm:max-w-sm">
    <form class="space-y-6" action="#" method="POST">
      <div>
        <label for="fullname" class="flex items-center justify-between block text-sm font-medium leading-6 text-gray-900">Full Name</label>
        <div class="mt-2">
      ...
      <div>
        <label for="email" class="flex items-center justify-between block text-sm font-medium leading-6 text-gray-900">Email</label>
        <div class="mt-2">
